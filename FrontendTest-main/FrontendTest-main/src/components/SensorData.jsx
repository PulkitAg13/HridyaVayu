    ...
    <div className="p-4 bg-gray-50 min-h-screen">
      ...
      >
        <div className="flex justify-between items-center">
          ...
          <div className="w-20">{renderTrend(sensorData.trends.aqi)}</div>
        </div>
      </div>
      ...
      <div className="mt-4 text-center">
        ...
        <button className="mt-2 bg-blue-500 text-white text-sm rounded-full px-4 py-2">
          Refresh Data
        </button>
      </div>
    </div>
...
// Expose a method to update the sensor data
SensorData.updateSensorData = (data) => {
  setSensorData((prev) => ({
    ...prev,
    no2: data.no2_level,
    so2: data.so2_level,
    ...
    // you can also push new AQI trend here if needed
    trends: {
      aqi: [...prev.trends.aqi.slice(1), data.air_quality], // update trends
    },
  }));
};
